...
public:
	ComputeShaderBase(class GLContext* glContext);
...
protected:
	...
	virtual bool OnApplyParameters() { return true; }
	virtual void OnGetDatas() = 0;

protected:
	class GLContext* m_glContext;
	class ComputeShaderProgram* m_computeShaderProgram;
